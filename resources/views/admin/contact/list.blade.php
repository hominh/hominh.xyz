		...
		<div class="col-md-12">
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-globe"></i>Contact
					</div>
					<div class="tools">
						<div class="dt-buttons">
						<a class="dt-button buttons-print btn default" tabindex="0" aria-controls="sample_2" href="#"><span>Add contact</span></a>
						...
						<thead>
                      	...
                      	<?php $stt = $stt + 1; ?>
                      		<tr>
								...
								<td> <a onclick="return confirmDelete('Are you sure Delete?')" href="{{ URL::route('admin.contact.delete',$item->id) }}"> Delete</a> </td>
								<td> <a href="{{ URL::route('admin.contact.edit',$item->id) }}">Show</a> </td>
                      		</tr>
                      	@endforeach()
                      	</tbody>
					</table>
